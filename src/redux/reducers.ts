...
import { ADD_TASKS_TO_STORAGE, ADD_TASK, REMOVE_TASK, UPDATE_TASK, TASKS_API_REQUEST_SUCCESS, TASKS_API_REQUEST_FAILED, 
    ADD_TASKS_TO_VIEW, ADD_TASK_TO_VIEW, REMOVE_TASK_FROM_VIEW, TASKS_API_REQUEST_STARTED, CATEGORIES_API_REQUEST_STARTED,
     CATEGORIES_API_REQUEST_SUCCESS, CATEGORIES_API_REQUEST_FAILED, ADD_CATEGORIES_TO_STORAGE, ADD_CATEGORY_TO_STORAGE,
      UPDATE_CATEGORY_IN_STORAGE, ADD_CATEGORIES_TO_VIEW, ADD_CATEGORY_TO_VIEW, REMOVE_CATEGORY_FROM_STORAGE, REMOVE_CATEGORY_FROM_VIEW 
} from "./actionNames";
